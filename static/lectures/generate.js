...
// 先导
lectures.intro["1000"].content =
	encrypt(
		fs.readFileSync(path.resolve(__dirname, "../../91alg-5/introduction.md")),
	);

lectures.intro["1001"].content =
	encrypt(fs.readFileSync(path.resolve(__dirname, "../../91alg-5/algo.md")));

lectures.intro["1002"].content =
	encrypt(fs.readFileSync(path.resolve(__dirname, "../../91alg-5/bigO.md")));

// 基础

[2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008].forEach(
	(id, i) => {
		lectures.basic[id].content =
			encrypt(
				fs.readFileSync(
...
[3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008].forEach(
	(id, i) => {
		lectures.topic[id].content =
			encrypt(
				fs.readFileSync(
...
[4001, 4002, 4003, 4004, 4005, 4006, 4007, 4008].forEach(
	(id, i) => {
		lectures.advance[id].content =
			encrypt(
				fs.readFileSync(
